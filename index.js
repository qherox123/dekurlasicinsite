...
client.ayarlar = {
  ...
  "oauthSecret": "", //bot secreti
	"callbackURL": "https://devlopxx.glitch.me/callback", //benim sitenin urlsini kendin ile değiş "/callback" kalacak!
	"kayıt": "", //onaylandı, reddedildi, başvuru yapıldı falan kayıtların gideceği kanalın ID'ini yazacaksın
  "vote": "", // VOTE LOG
  "renk": "RANDOM",
  "rapor": "757566142305796176" // REPORT LOG
};



client.yetkililer = ['','756582469217681448'] //tüm yetkililerin ıdleri gelcek array
client.webyetkililer = ['','757565901280116736'] //web yetkililerin ıdleri gelcek array
client.sunucuyetkililer = ['757565901280116736','  '] //sunucu yetkililerin ıdleri gelcek array
...
client.on("message", async message => {
    ...
    if (cmd.conf.permLevel === 'ozel') { //o komutu web yetkilileri kullanabsiln sadece diye yaptıgım bişe 
      ...
      var arr = [x.owner.id, '586822327568695317','586822327568695317','586822327568695317']
...
client.login("NzUwMDI2NjI1NzAxMjQ5MTU2.X00iug.X9sYSC8QFMVWPCX0xliW9oIpPQ8") //tokeni yaz işte

process.env = {}
process.env.TOKEN = "NzUwMDI2NjI1NzAxMjQ5MTU2.X00iug.X9sYSC8QFMVWPCX0xliW9oIpPQ8";
